...
// mySigningKey signs and validates auth tokens. Configure it via the
// JWT_SECRET environment variable in any non-local environment.
var mySigningKey = []byte(constants.JWT_SECRET)

// usernamePattern requires 3-20 alphanumeric/underscore characters.
...
func signupHandler(w http.ResponseWriter, r *http.Request) {
	...
	if user.Username == "" || user.Password == "" || !usernamePattern.MatchString(user.Username) {
