...
export default function Landing() {
  ...
  // Image generation goes through our own backend now (POST /generate-image)
  // instead of calling OpenAI directly from the browser. The backend holds
  // the OpenAI API key in an environment variable, so the key never ships
